...
const Chat = () => {
  ...
  return (
    <div className="bg-[#2c2e3a] h-screen text-[#9e9e9e] flex items-center justify-center p-10">
      <div className="flex flex-col items-center justify-between border border-blue-600 rounded-xl p-6 h-full w-full max-w-xl mx-auto shadow-[0_4px_30px_rgba(0,0,255,0.3)]">
